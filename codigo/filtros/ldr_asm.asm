...
; XMM0 = [Sumargb1|Sumargb2]
	...
	psrldq xmm1, 2			; XMM1 = [Sg1|Sr1| 0 |Sb2|Sg2|Sr2| 0 | 0 ]
	movdqu xmm2, xmm1
	psrldq xmm2,2				; XMM2 = [Sr1| 0 |Sb2|Sg2|Sr2| 0 | 0 | 0 ]
...
; XMM5 = [Sumargb3|Sumargb4]
	...
	psrldq xmm6, 2			; XMM6 = [Sg3|Sr3| 0 |Sb4|Sg4|Sr4| 0 | 0 ]
	movdqu xmm7, xmm6
	psrldq xmm7,2				; XMM7 = [Sr3| 0 |Sb4|Sg4|Sr4| 0 | 0 | 0 ]
