...
cropflip_asm:
	...
	je .fin
	sub rdi, rdx ;Llegue al final de la fila. Ahora resto una tira de columnas entera (o sea, bajo de fila) y resto el tamx. entonces ahora estoy al principio de la fila de abajo, respetando el offset
	sub rdi, r13
